...
int main()
{
     ...
     */
     ...
     /*
     // Concatenating string literals: No - Compiler Error
     ...
     */
     ...
     std::cout << "str15: " << str15 << std::endl; // Hello ?????
     ...
     std::cout << "str18 : " << str18 << std::endl; // Hello world

     // Direct output
     std::string str19{"Hello "};
     std::cout << "Direct output: " << str19.append(str16, 4, 5) << std::endl; // Hello world
     */
     ...
     (str23 += ',') += ' ';
     std::cout << "str23 : " << str23 << std::endl; // Hello,
     ...
     std::cout << "str26 : " << str26 << std::endl; // Hello, I am here to see you.
     */
     ...
     */
     ...
     str26 += std::to_string(34.91f);              // Treats 67 as a character code
                                                   ...
                                                   // literally
     std::cout << "str26: " << str26 << std::endl; // Hello 34.910000
     */
