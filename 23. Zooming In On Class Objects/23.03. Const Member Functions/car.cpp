...
// Getters
std::string_view Car::get_name() const
{
     // return name;
     return this->name;
}

std::string_view Car::get_company() const
{
     return company;
}
...
// Setters
void Car::set_name(std::string_view car_name)
{
     // name = car_name;
     this->name = car_name;
}

void Car::set_company(std::string_view car_company)
{
     company = car_company;
}
