...
void compute(int age = 19, double weight = 90.3, double distance = 180.5);

void greet_teacher(std::string_view name_sv = "teacher", int homeworks = 12, int exams = 4, double pass_rate = 0.8, std::string_view first_dpmt = "Computer Science");

int main()
{
     // compute(); // Doing computations on age: 19 weight: 90.3 and distance: 180.5
